...
namespace AudioTools
{
    ...
    public class AudioObject : MonoBehaviour
    {
        ...
        FMOD.Studio.EVENT_CALLBACK instanceCreatedCallback;
        ...
        void Awake()
        {
            ...
            {
                instanceCreatedCallback = new FMOD.Studio.EVENT_CALLBACK(EventInstanceCreatedCallback);
            }
