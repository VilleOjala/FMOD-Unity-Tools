...
namespace AudioTools
{
    ...
    public class BaseAmbienceArea : MonoBehaviour
    {
        ...
        private List<SpotAmbience> enteredSpotAmbienceAreas = new List<SpotAmbience>();
        ...
        public void ReportEnteredSpotAmbienceArea (SpotAmbience spotAmbience)
        {
        ...
        public void ReportExitedSpotAmbienceArea (SpotAmbience spotAmbience)
        {
            if (enteredSpotAmbienceAreas.Contains(spotAmbience))
            {
