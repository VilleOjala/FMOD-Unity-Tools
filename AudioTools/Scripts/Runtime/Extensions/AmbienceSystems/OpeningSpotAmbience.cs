...
{
    [AddComponentMenu("Audio Tools/Extensions/Ambience Systems/Opening Spot Ambience")]
    [RequireComponent(typeof(SphereCollider), typeof(Rigidbody))]
    public class OpeningSpotAmbience : MonoBehaviour
    {
        [FMODUnity.EventRef]
        ...
        private OpeningAmbienceTransitioner parentAmbienceArea = null;
        ...
        public bool InitializeSpotAmbience(OpeningAmbienceTransitioner parentAmbienceArea)
        {
            if (IsInitialized)
            {
