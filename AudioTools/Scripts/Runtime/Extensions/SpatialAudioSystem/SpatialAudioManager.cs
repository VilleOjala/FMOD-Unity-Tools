...
namespace AudioTools
{
    ...
    public class SpatialAudioManager : MonoBehaviour
    {
        ...
        public void RegisterRoomAwareInstance(FMOD.Studio.EventInstance instance, Transform transform, float maxDistance, SpatialAudioRoom initialRoom = null)
        {
        ...
        private bool CheckIfPositionIdentical(Vector3 posA, Vector3 posB) // HERE
        {
...
#if UNITY_EDITOR
                if (result != FMOD.RESULT.OK)
                    Debug.LogWarning("The scaling of the rolloff distance failed. Fmod error: " + result);
#endif
            }
        }
